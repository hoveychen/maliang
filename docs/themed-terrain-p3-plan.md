...
- ⬜ **厨房 kitchen / 医院 hospital / 未来机器人 future_robot**：照上方配方各配专属墙贴图搭房间。
  - 厨房：白瓷砖墙（新 wall_kitchen 或复用 tile）｜医院：浅色医院墙（PROC plaster/vinyl 立面）
  - 未来：金属舱壁（新 wall_future 带面板 或复用 metal_plate）
