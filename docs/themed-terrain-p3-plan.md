...
- [ ] ② 侏罗纪 jurassic（层 17-21）
- [ ] ③ 中世纪 medieval（层 22-24）
- [ ] ④ 罗马 roman（层 25-26，复用 17/21/23）
- [ ] ⑤ 中国古代 ancient_china（层 27，复用 22/23/17）
- [ ] ⑥ 现代城市 modern_city（层 28-32；30 PROC）
- [ ] ⑦ 玩具房间 toy_room（层 33-35 PROC，复用 7/27）
- [ ] ⑧ 厨房 kitchen（层 36-37，复用 7/27）
- [ ] ⑨ 医院 hospital（层 38-39 PROC，复用 7/31/37）
- [ ] ⑩ 未来机器人 future_robot（层 40-43；42/43 PROC，复用 31）
