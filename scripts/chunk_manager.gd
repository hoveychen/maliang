...
const LANDMARKS := [
	...
	{ "scene": HOUSE_SCENES[2], "tile": Vector2i(30, 43), "scale": HOUSE_SCALE, "yaw": 90.0, "reserve": 1, "search": 2 },
	{ "scene": HOUSE_SCENES[3], "tile": Vector2i(44, 44), "scale": HOUSE_SCALE, "yaw": 270.0, "reserve": 1, "search": 2 },
	{ "scene": HOUSE_SCENES[1], "tile": Vector2i(28, 41), "scale": HOUSE_SCALE, "yaw": 0.0, "reserve": 1, "search": 2 },
