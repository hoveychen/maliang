...
var _dress_self := false            ## 自贴装扮态（手机「装扮」app 进入）：贴纸盘对着玩家自己
...
## 从手机「装扮」app 进入：对自己开贴纸盘。收起手机跨页停靠、保留近身相机框住玩家、亮自贴盘。
## 装扮态吞世界点击（见 _unhandled_input），点盘外空白 = 退出装扮。
func _begin_dress_self() -> void:
