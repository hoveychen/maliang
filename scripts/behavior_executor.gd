...
## 26 种纸片动作（动画数学见 world.action_pose；新增动作两边都要加，缺实现的会呆立占时长）。
const ACTION_DUR := {
	# 基础 4 种
	"wave": 1.6, "jump": 1.0, "spin": 1.1, "nod": 1.4,
	# 翻滚旋转
	"flip": 1.2, "backflip": 1.2, "cartwheel": 1.3, "twirl": 1.4, "helicopter": 2.2,
	# 纸片专属梗（翻面/侧立隐身/躺平/扑街）
	"paperflip": 1.8, "peek": 1.6, "lie_down": 2.0, "faceplant": 1.8,
	# 纸形变（shader curl/flutter）
	"curl_up": 1.8, "shiver": 1.2, "wiggle": 2.0, "puff": 1.4,
	# squash & stretch
	"bounce": 1.6, "squish": 1.2, "stretch": 1.4,
