...
export const T_KITCHEN_WALL = 45;  // 厨房墙面（室内房间围墙）
export const T_HOSPITAL_WALL = 46; // 医院墙面（室内房间围墙）
export const T_FUTURE_WALL = 47;   // 未来舱壁墙面（室内房间围墙）
export const T_YELLOW_BRICK = 48;  // 黄砖路（绿野仙踪专属；paver_brick 纹理 + 金黄 tint）
