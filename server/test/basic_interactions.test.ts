...
test('mock routeIntent：跟随/停跟/动作/找人聊天启发式（离线开发路径）', async () => {
  ...
  for (const [say, want] of [['翻个跟头', 'flip'], ['翻面看看', 'paperflip'], ['躺平吧', 'lie_down'], ['把自己拍扁', 'squish'],
    ['折个纸飞机', 'paper_plane'], ['对折一下', 'fold'], ['折个角', 'corner_wink'], ['鞠个躬', 'bow_fold'], ['揉成纸团', 'crumple_ball']] as const) {
